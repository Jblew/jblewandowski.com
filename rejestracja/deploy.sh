...
gcloud run deploy "${SERVICE_NAME}" \
  ...
  --set-env-vars=BASE_URL="${BASE_URL}",FRONTEND_URL="${FRONTEND_URL}",TPAY_API_URL="${TPAY_API_URL}",TPAY_CLIENT_ID="${TPAY_CLIENT_ID}",TPAY_CLIENT_SECRET="${TPAY_CLIENT_SECRET}" \
